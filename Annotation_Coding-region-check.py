...
class SearchDB(fileHandler):
	...
	def Search_CODON(self,readfl1,workdir):
		...
		cmd1 = "java -Xmx12g -jar "+GATK+" -T VariantFiltration -R "+HG19+" -V "+readfl1+" -o "+WORK+"snp_clsters2_ws3.vcf --clusterSize 2 --clusterWindowSize 3"
...
clF1 = SearchDB().Search_CODON(sys.argv[1],sys.argv[3])
clF2 = SearchDB().TWO_VAR(sys.argv[3])
clF3 = SearchDB().THREE_VAR(sys.argv[3])
clF4 = SearchDB().PARS_OUT_VAR(sys.argv[2],sys.argv[3])
